    ...
    def CompileExpr(self, e, env):
        match e:
            ...
            case Expr("[loop]", params):
                ...
                # interchange
                global interchange
                if index in interchange.keys():
                    index = interchange[index]
                    bound = interchange[bound]
...
def main():
  ...
  schedule_arr = [s for s in schedule.readline().strip().split(" ") if s]
  
  swap_index_1, swap_bound_1 = schedule_arr[1], iterators[schedule_arr[1]]
  swap_index_2, swap_bound_2 = schedule_arr[2], iterators[schedule_arr[2]]
  
  global interchange
  interchange = {
      swap_index_1 : swap_index_2,
      swap_index_2 : swap_index_1,
      swap_bound_1 : swap_bound_2,
      swap_bound_2 : swap_bound_1
  }
