...
def main():
    ...
    output_file_name = 'versions/' + sys.argv[1]
    operation_file_name  = '../operations/' + sys.argv[2]
    schedule_file_name  = '../schedules/' + sys.argv[3]

    with open(operation_file_name, 'r') as opf:
