/*
  This is the SSA version of the unrolled r loop implementation.
...
#ifndef COMPUTE_NAME
#define COMPUTE_NAME ssa_unroll_r
#endif

#ifndef COMPUTE_FLOP_NAME
#define COMPUTE_FLOP_NAME ssa_unroll_r_flop
#endif

#ifndef COMPUTE_BYTES_NAME
#define COMPUTE_BYTES_NAME ssa_unroll_r_bytes
#endif
