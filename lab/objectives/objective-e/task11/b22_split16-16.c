...
for (int q0_o = 0; q0_o < (Q); q0_o += 16) {
for (int q0_i = 0; q0_i < 16; q0_i += 1) {
for (int r0_o = 0; r0_o < (R); r0_o += 16) {
for (int r0_i = 0; r0_i < 16; r0_i += 1) {
    {
