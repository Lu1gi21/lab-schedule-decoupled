...
for (int j0_o = 0; j0_o < n0; j0_o += 4) {
for (int q0 = 0; q0 < (Q); q0 += 1) {
for (int i0_i = 0; i0_i < 4; i0_i += 1) {
    {
    ...
    int y_ij_idx = y_ij_offset + (j0_o + 0);
    ...
    *y_ij_addr = acc_y_ij;
    ...
    float x_iqjr = *x_iqjr_addr;
    int y_ij_offset = (i0_o + i0_i) * n0;
    int y_ij_idx = y_ij_offset + (j0_o + 1);
    float *y_ij_addr = &y[y_ij_idx];
    float y_ij = *y_ij_addr;
    float res_wx = w_qr * x_iqjr;
    float acc_y_ij = y_ij + res_wx;
    *y_ij_addr = acc_y_ij;
    ...
    float x_iqjr = *x_iqjr_addr;
    int y_ij_offset = (i0_o + i0_i) * n0;
    int y_ij_idx = y_ij_offset + (j0_o + 2);
    float *y_ij_addr = &y[y_ij_idx];
    float y_ij = *y_ij_addr;
    float res_wx = w_qr * x_iqjr;
    float acc_y_ij = y_ij + res_wx;
    *y_ij_addr = acc_y_ij;
    ...
    float x_iqjr = *x_iqjr_addr;
    int y_ij_offset = (i0_o + i0_i) * n0;
    int y_ij_idx = y_ij_offset + (j0_o + 3);
    float *y_ij_addr = &y[y_ij_idx];
    float y_ij = *y_ij_addr;
    float res_wx = w_qr * x_iqjr;
    float acc_y_ij = y_ij + res_wx;
