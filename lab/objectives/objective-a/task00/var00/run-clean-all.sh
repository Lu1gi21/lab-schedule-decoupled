...
#make -C ../.. clean-results FILE_REF=./examples/basic/baseline.c FILE_TST=./examples/basic/baseline.c
make -C ../.. clean-results FILE_REF=./examples/basic/baseline.c FILE_TST=./examples/basic/baseline.c
make -C ../.. clean-results FILE_REF=./examples/basic/baseline.c FILE_TST=./examples/basic/test_var000.c
