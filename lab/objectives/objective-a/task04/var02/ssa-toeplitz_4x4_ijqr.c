...
//   //r=0    1     2     3
//   {-1.0,  0.20, 0.33, 0.50,   // q=0
//     0.50, -1.0, 0.20, 0.33,   // q=1
//     0.33,  0.50, -1.0, 0.20,  // q=2
//     0.20,  0.33, 0.50, -1.0   // q=3
//   }; 
...
void COMPUTE_NAME( int m0, int n0, float *x, float *y, float *weights) {
...
void COMPUTE_NAME_SPLIT( int m0, int n0, float *x, float *y, float *weights) {
  for( int i0 = 0; i0 < m0; ++i0 ) {
    for( int j0_o = 0; j0_o < n0; j0_o += 2) {
      for( int j0_i = 0; j0_i < 2; ++j0_i ) {
        for( int q0 = 0; q0 < (Q); ++q0 ) {
          for (int r0 = 0; r0 < (R); ++r0) {
            BEGIN_INSTRUMENTATION;
          {
          y[i0*n0+(j0_o + j0_i)]  += weights[q0*(R)+r0] *
            x[ ((q0+i0)%m0)*n0 + ((r0+(j0_o + j0_i))%n0)  ];
            END_INSTRUMENTATION;
            }
          }
        }
...
void COMPUTE_NAME_INTERCHANGE( int m0, int n0, float *x, float *y, float *weights) {
  for( int i0 = 0; i0 < m0; ++i0 ) {
    for (int j0_o = 0; j0_o < n0; j0_o += 2) {
      for (int r0 = 0; r0 < (R); ++r0) {
        for (int q0 = 0; q0 < (Q); ++q0) {
...
void COMPUTE_NAME_UNROLL ( int m0, int n0, float *x, float *y, float *weights) {
  for( int i0 = 0; i0 < m0; ++i0 ) {
    for( int j0_o = 0; j0_o < n0; j0_o += 2) {
      for( int r0 = 0; r0 < (R); ++r0 ) {
        for( int q0 = 0; q0 < (Q); ++q0 ) {
          BEGIN_INSTRUMENTATION;
          { 
            y[i0*n0+(j0_o+1)]  += weights[q0*(R)+r0] *
              x[ ((q0+i0)%m0)*n0 + ((r0+(j0_o + 0))%n0)  ];
          }
          {
            y[i0*n0+(j0_o+1)]  += weights[q0*(R)+r0] *
              x[ ((q0+i0)%m0)*n0 + ((r0+(j0_o + 1))%n0)  ];
          }
          END_INSTRUMENTATION;
        }
      }
