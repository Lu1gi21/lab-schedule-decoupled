  ...
  for( int i0 = 0; i0 < m0; ++i0 )
      ...
      for( int j0 = 0; j0 < n0; ++j0 )
	{
	  ...
	  for( int q0 = 0; q0 < (Q); ++q0 )
	  {
	    ...
	    { // r0 = 0
	      y[i0*n0+j0]  += weights[q0*(R)+(0)] *
		x[ ((q0+i0)%m0)*n0 + (((0)+j0)%n0)  ];
	    }
	    { // r0 = 1
	      y[i0*n0+j0]  += weights[q0*(R)+(1)] *
		x[ ((q0+i0)%m0)*n0 + (((1)+j0)%n0)  ];
	    }
	    { // r0 = 2
	      y[i0*n0+j0]  += weights[q0*(R)+(2)] *
		x[ ((q0+i0)%m0)*n0 + (((2)+j0)%n0)  ];
	    }
	    { // r0 = 3
	      y[i0*n0+j0]  += weights[q0*(R)+(3)] *
		x[ ((q0+i0)%m0)*n0 + (((3)+j0)%n0)  ];
	    }
